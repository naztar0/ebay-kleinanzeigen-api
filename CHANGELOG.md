...
- Validate incoming `X-Request-ID`: strip outer whitespace, enforce max length 128 and printable ASCII only; replace invalid values with a server-generated UUID before logging or echoing in the response
